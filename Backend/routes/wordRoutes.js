...
import { getWords, createWord, updateWord, updateTimesLearned, getRandomWord, getAnswersMeaning, updateHideWord } from '../controllers/wordController.js';
...
router.put('/update-hide-word/:id/:isHidden', updateHideWord)
